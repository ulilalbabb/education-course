      ...
      <div className="lg:pl-10 lg:pt-5 px-5 w-full">
        ...
        <div className="py-5">
          <div className="py-5 px-5 border bg-white border-gray-200 rounded-2xl">
            ...
            <div className="text-sm md:text-lg py-2 flex md:justify-between lg:justify-between">
              <p className="pr-10">Video Learning Gapai Karier Impianmu sebagai Seorang UI/UX Designer & Product Manager</p>
              <p className="font-bold">Rp 499.000</p>
            </div>
            <div className="text-sm md:text-lg py-5 flex justify-between">
              <p>Admin</p>
              <p className="font-bold">Rp 20.000</p>
            </div>
            <hr />
            <div className="text-sm py-3 flex items-center justify-between">
              <p className="font-bold md:text-lg">Total Pembayaran</p>
              <p className="font-bold text-lg md:text-2xl text-green-500">Rp 519.000</p>
            </div>
            <Button variant="bg-green-600 hover:bg-green-400 cursor-pointer text-white py-1 font-semibold w-full md:text-lg rounded-xl">
              <p>Beli Sekarang</p>
            </Button>
          </div>
        </div>
