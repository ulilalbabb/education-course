...
const PaymentMethod = () => {
  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      <button onClick={toggleDropdownBank} className="flex justify-between w-full border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium hover:bg-gray-50 ">
        Transfer bank
        ...
        <div className="rounded-md shadow-lg bg-white">
          <div className="py-1">
            {banksOptions.map((bank) => (
              <button key={bank.id} onClick={() => setSelectedBank(bank)} className=" px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left flex items-center justify-between">
                <div>
      ...
      <button onClick={toggleDropdownEWallet} className="flex justify-between w-full border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium hover:bg-gray-50 ">
        E-Wallet
        ...
        <div className="rounded-md shadow-lg bg-white">
          <div className="py-1">
            {eWalletOptions.map((eWallet) => (
              <button key={eWallet.id} onClick={() => setSelectedEWallet(eWallet)} className=" px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left flex items-center justify-between">
                <div>
      ...
      <button onClick={toggleDropdownCreditCard} className="flex justify-between w-full border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium hover:bg-gray-50 ">
        Kartu Kredit/Debit
        ...
        <div className="rounded-md shadow-lg">
          <div className="py-1">
            {creditCardOptions.map((credit) => (
              <button key={credit.id} onClick={() => setSelectedCreditCard(credit)} className=" px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full flex items-center justify-between">
                <div>
