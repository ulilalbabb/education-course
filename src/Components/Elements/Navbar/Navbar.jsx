...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white py-4 px-6 lg:px-12 md:px-12">
        ...
        <p className='hidden lg:block md:block cursor-pointer hover:duration-200 hover:text-amber-500'>
          ...
          >
            <div className="flex flex-col items-center gap-0.5 cursor-pointer">
              ...
              <span className='hidden lg:block md:block cursor-pointer hover:text-amber-500'><CgProfile size={30}/></span>
            </div>
          </button>
          {isOpen && (
            <div className="absolute right-0 mt-10 w-95 lg:w-50 bg-white rounded-md shadow-lg z-10">
              <ul className="py-2">
                <li>
                  <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Kategori</a>
                </li>
                <li>
                  <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Profil Saya</a>
                </li>
                <li>
                  <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Kelas Saya</a>
                </li>
                <li>
                  <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Pesanan Saya</a>
                </li>
                <li>
